...
public class customerNavigation extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_camera) {
            Intent intent1 = new Intent(customerNavigation.this, customerNavigation.class);
            startActivity(intent1);
            // Handle the camera action
        }

        else if (id == R.id.nav_gallery) {
            Intent intent2 = new Intent(customerNavigation.this, profileCustomerActivity.class);
            startActivity(intent2);

        } else if (id == R.id.nav_slideshow) {
            Intent intent3 = new Intent(customerNavigation.this, ScheduleCustomerActivity.class);
            startActivity(intent3);

        } else if (id == R.id.nav_manage) {
            Intent intent4 = new Intent(customerNavigation.this, pastCustomerActivity.class);
        ...
        if (id == R.id.nav_extra) {
            Intent intent5 = new Intent(customerNavigation.this, notifcationCustomerActivity.class);
            ...
            Intent intent = new Intent(customerNavigation.this, loginCustomer.class);
