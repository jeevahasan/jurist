...
public class CustomerEventHistory extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        firebaseUserSearch("lqVC1NfaD9cw4GFHqQen9KP0yUP2");
    ...
    private void firebaseUserSearch(String searchText) {
        ...
        Toast.makeText(CustomerEventHistory.this, "Started Search", Toast.LENGTH_LONG).show();

        Query firebaseSearchQuery = databaseReference.orderByChild("lawyer_uid").startAt(searchText).endAt(searchText + "\uf8ff");



        FirebaseRecyclerAdapter<FreeEvents, CustomerEventHistory.UsersViewHolder> firebaseRecyclerAdapter = new FirebaseRecyclerAdapter<FreeEvents, UsersViewHolder>(
                FreeEvents.class,
                R.layout.list_layout1,
                CustomerEventHistory.UsersViewHolder.class,
                firebaseSearchQuery
