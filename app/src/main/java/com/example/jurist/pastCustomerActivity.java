...
public class pastCustomerActivity extends AppCompatActivity {
    ...
    private void firebaseUserSearch(String searchText) {
        ...
        Toast.makeText(pastCustomerActivity.this, "Started Search", Toast.LENGTH_LONG).show();

        Query firebaseSearchQuery = mUserDatabase.orderByChild("customer_uid").startAt(searchText).endAt(searchText + "\uf8ff");
